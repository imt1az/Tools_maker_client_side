...
const ProductDetail = () => {
  ...
  // get Product Details
  // const {data:products,isLoading} = useQuery('products',()=> fetch(`https://stormy-brook-85190.herokuapp.com/productDetail/${_id}`)
  // .then(res=>res.json())
  // .then(data => {
  //     if(data){
  ...
  //  },[quantity])
  useEffect(() => {
    fetch(`https://stormy-brook-85190.herokuapp.com/productDetail/${_id}`)
      .then((res) => res.json())
      .then((data) => {
        setProduct(data);
